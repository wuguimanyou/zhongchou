			...
			<tbody><tr>
				<td width="50%" valign="top">
					...
					<?php if($is_shopdistr){ ?>
						...
						<div class="input" style="height:90px;">
						<label>
						  <input type=radio name="member_template_type" <?php if($member_template_type==1){ ?>checked=true<?php } ?> value=1>传统模式</label><br/>
						  <label>&nbsp;<input type=radio name="member_template_type" <?php if($member_template_type==2){ ?>checked<?php } ?> value=2>微店模式</label><br/>
						  <label>&nbsp;<input type=radio name="member_template_type" <?php if($member_template_type==3){ ?>checked<?php } ?> value=3>单品模式</label>
						</div>
				...
				<td width="50%" valign="top">
					...
					<div class="input" style="height:120px;">
					<label> <input type=radio name="watertype" <?php if($watertype==1){ ?>checked=true<?php } ?> value=1>风格1</label><br/>
					<label>&nbsp;<input type=radio name="watertype" <?php if($watertype==2){ ?>checked<?php } ?> value=2>风格2</label><br/>
					<label>&nbsp;<input type=radio name="watertype" <?php if($watertype==3){ ?>checked<?php } ?> value=3>风格3</label><br/>
					</div>
